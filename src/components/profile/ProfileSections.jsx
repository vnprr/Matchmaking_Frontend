...
const ProfileSections = () => {
    const { profileSections, loading, error, isOwnProfile, updateProfileSection } = useProfile();
    ...
    const handleSaveSection = async (sectionId) => {
        try {
            ...
            if (updateProfileSection) {
                updateProfileSection(sectionId, editedContent);
            }
    ...
    return (
        <Box width="100%">
            ...
            {(!profileSections || profileSections.length === 0) ? (
                    ...
                    {profileSections.map((section) => (
                        <Box key={section.sectionId}>
                            <Flex align="center" justify="space-between" mb={2}>
                                ...
                                {isOwnProfile && editingSectionId !== section.sectionId && (
                                    <Button
                                        size="sm"
                                        leftIcon={<EditIcon />}
